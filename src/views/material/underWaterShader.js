...
export const UnderWaterShader = {
  ...
  uniforms: {
    // 上一个渲染通道渲染出来的Buff，这个Shander用不到
    'tDiffuse': { value: null },
    'iTime': { value: 0.0 },
    'iResolution': { value: new THREE.Vector2(0.0, 0.0) },
    'iMouse': { value: new THREE.Vector2(0.0, 0.0) },

    'skyColor': { value: new THREE.Vector3(0.3, 1.0, 1.0) },
    'sunLightColor': { value: new THREE.Vector3(1.7, 0.65, 0.65) },
    'skyLightColor': { value: new THREE.Vector3(0.8, 0.35, 0.15) },
    'indLightColor': { value: new THREE.Vector3(0.4, 0.3, 0.2) },
    'horizonColor': { value: new THREE.Vector3(0.0, 0.05, 0.2) },
    'sunDirection': { value: new THREE.Vector3(0.8, 0.8, 0.6) },
    'cameraPos': { value: new THREE.Vector3(0.0, 0.0, 0.0) },
    'cameraLook': { value: new THREE.Vector3(1.0, 1.0, 1.0) },
...
void main()
{
    ...
    vec3 eye = cameraPos;
    vec2 rot = 6.2831 * (vec2(-0.05 + 0.01, 0.0 - sin(0.5) * 0.01) + vec2(1.0, 0.0) * (cameraLook.xy - iResolution.xy * 0.25) / iResolution.x);
